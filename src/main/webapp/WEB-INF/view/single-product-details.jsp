...
<body>
    ...
    <header class="header_area">
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
            ...
            <nav class="classy-navbar" id="essenceNav">
                <!-- Logo -->
                <a class="nav-brand" href="${pageContext.request.contextPath}/resources/index.html"><img src="${pageContext.request.contextPath}/resources/img/core-img/logo.png" alt=""></a>
                <!-- Navbar Toggler -->
                ...
                <div class="classy-menu">
                    ...
                    <div class="classynav">
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/resources/#">Shop</a>
                                <div class="megamenu">
    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_desc clearfix">
            ...
            <p class="product-price"><span class="old-price">&#36;65.00</span>&#36;${item.price}</p>
