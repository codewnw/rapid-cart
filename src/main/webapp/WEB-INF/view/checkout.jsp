...
<body>
		...
		<div
							...
							<li><a href="#">Shop</a>
								<div class="megamenu">
									...
									<div class="single-mega cn-col-4">
										<img
											src="${pageContext.request.contextPath}/resources/img/bg-img/bg-6.jpg"
											alt="">
									</div>
								</div></li>
							<li><a href="#">Pages</a>
			...
			<div class="header-meta d-flex clearfix justify-content-end">
				...
				<div class="user-login-info">
					<a href="#"><img
						src="${pageContext.request.contextPath}/resources/img/core-img/user.svg"
						alt=""></a>
				</div>
				<!-- Cart Area -->
				<div class="cart-area">
					<a href="#" id="essenceCartBtn"><img
						src="${pageContext.request.contextPath}/resources/img/core-img/bag.svg"
						alt=""> <span>3</span></a>
				</div>
			</div>
			...
			<div class="cart-list">
				...
				<div class="single-cart-item">
					<a href="#" class="product-image"> <img
						src="${pageContext.request.contextPath}/resources/img/product-img/product-1.jpg"
				...
				<div class="single-cart-item">
					<a href="#" class="product-image"> <img
						src="${pageContext.request.contextPath}/resources/img/product-img/product-2.jpg"
						class="cart-thumb" alt=""> <!-- Cart Item Desc -->
						<div class="cart-item-desc">
							<span class="product-remove"><i class="fa fa-close"
								aria-hidden="true"></i></span> <span class="badge">Mango</span>
				...
				<div class="single-cart-item">
					<a href="#" class="product-image"> <img
						src="${pageContext.request.contextPath}/resources/img/product-img/product-3.jpg"
						class="cart-thumb" alt=""> <!-- Cart Item Desc -->
						<div class="cart-item-desc">
							<span class="product-remove"><i class="fa fa-close"
								aria-hidden="true"></i></span> <span class="badge">Mango</span>
	...
	<div class="breadcumb_area bg-img"
		style="background-image: url(${pageContext.request.contextPath}/resources/img/bg-img/breadcumb.jpg);">
				...
				<div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
					<div class="order-details-confirmation">
						...
						<ul class="order-details-form mb-4">
							...
							<c:set var="shippingCharge" value="5" />
							<c:forEach var="item" items="${items}">
								<c:set var="subTotal" value="${subTotal +  item.price}" />
								<li><span>${item.name}</span> <span>&#36;${item.price}</span></li>
							</c:forEach>
							<li><span>Subtotal</span> <span>&#36;${subTotal}</span></li>
							<li><span>Shipping</span> <span>${shippingCharge eq 0? 'Free': shippingCharge }</span></li>
							<li><span>Total</span> <span>&#36;${subTotal +  shippingCharge}</span></li>
						</ul>
...
<form:form method="post" action="${pageContext.request.contextPath}/carts/place-order" modelAttribute="checkout">
	...
	<!-- Classy Nav js -->
	<script
		src="${pageContext.request.contextPath}/resources/js/classy-nav.min.js"></script>
	<!-- Active js -->
