...
<body>
							...
							<li><a href="#">Shop</a>
								<div class="megamenu">
									...
									<div class="single-mega cn-col-4">
										<img src="resources/img/bg-img/bg-6.jpg" alt="">
									</div>
								</div></li>
							<li><a href="#">Pages</a>
								<ul class="dropdown">
			...
			<div class="cart-list">
				...
				<div class="single-cart-item">
					<a href="#" class="product-image"> <img
						src="resources/img/product-img/product-1.jpg" class="cart-thumb"
						alt=""> <!-- Cart Item Desc -->
				...
				<div class="single-cart-item">
					<a href="#" class="product-image"> <img
						src="resources/img/product-img/product-2.jpg" class="cart-thumb"
						alt=""> <!-- Cart Item Desc -->
						<div class="cart-item-desc">
							<span class="product-remove"><i class="fa fa-close"
								aria-hidden="true"></i></span> <span class="badge">Mango</span>
				...
				<div class="single-cart-item">
					<a href="#" class="product-image"> <img
						src="resources/img/product-img/product-3.jpg" class="cart-thumb"
						alt=""> <!-- Cart Item Desc -->
						<div class="cart-item-desc">
							<span class="product-remove"><i class="fa fa-close"
								aria-hidden="true"></i></span> <span class="badge">Mango</span>
	...
	<section class="welcome_area bg-img background-overlay"
		style="background-image: url(resources/img/bg-img/bg-1.jpg);">
			...
			<div class="row justify-content-center">
				...
				<div class="col-12 col-sm-6 col-md-4">
					<div
						...
						style="background-image: url(resources/img/bg-img/bg-2.jpg);">
				...
				<div class="col-12 col-sm-6 col-md-4">
					<div
						class="single_catagory_area d-flex align-items-center justify-content-center bg-img"
						style="background-image: url(resources/img/bg-img/bg-3.jpg);">
						<div class="catagory-content">
							<a href="#">Shoes</a>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="cta-content bg-img background-overlay"
						style="background-image: url(resources/img/bg-img/bg-5.jpg);">
				...
				<div class="col-12 col-md-6">
					<div class="single_widget_area d-flex mb-30">
						...
						<div class="footer-logo mr-50">
							<a href="#"><img src="resources/img/core-img/logo2.png"
								alt=""></a>
						</div>
						<!-- Footer Menu -->
